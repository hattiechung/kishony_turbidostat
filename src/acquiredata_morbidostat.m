function [sample_data, relative_sample_time, state_change, rawdata] = acquiredata_morbidostat(ai, params, experimentStartTime, acquisitionTime, handles)
%
%
...
set(ai, 'SamplesPerTrigger', sampleRate*0.85); % Is this used? LKS
waitTime = 1.5;
...
sample_time = zeros(ceil(acquisitionTime)*2, 1); % Not used. LKS
